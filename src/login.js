            ...
            <form className='login-form'>
                <div className='col-sm-7 row'>
                    <input
                      ...
                      validate="text"
                    />
                    <span className={this.state.formDataErrors.name ? '' : 'd-none'}>wrong name</span>
                </div>
                <div className='col-sm-7 row'>
                    <input
                      type='text'
                    ...
                    />
                    <span className={this.state.formDataErrors.email ? '' : 'd-none'}>wrong name</span>
                </div>
                <div className='col-sm-7 row'>
                    <input
                      type='text'
                      ...
                      validate="text"
                    />
                    <span className={this.state.formDataErrors.color ? '' : 'd-none'}>wrong name</span>
                    </div>
                <div className='col-sm-7 row'>
                    <input
                      type='text'
                      ...
                      validate="hex"
                    />
                    <span className={this.state.formDataErrors.colorName ? '' : 'd-none'}>wrong name</span>
                </div>
                ...
                <div className='col-sm-7 row'>
                    <input 
                        type='checkbox' 
                        name="is_checked"
                        onChange={(e) => this.saveInputValue(e)} defaultChecked={false} 
